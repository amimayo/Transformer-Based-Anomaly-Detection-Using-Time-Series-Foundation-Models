...
def run_baselines_test(train_path, test_path, test_label_path, algo, window_size, few_shot_rate):
...
def main():
    ...
    run_baselines_test(train_path, test_path, test_label_path, algo, window_size, few_shot_rate)
